...
typedef signed short  nero_s16int;
typedef unsigned short  nero_us16int;
...
#define DataFlowProcess_error_Msg23
...
*/
// 翻转字节顺序 (16-bit)
// public static UInt16 ReverseBytes(nero value)
// {
//   return (UInt16)((value & 0xFFU) << 8 | (value & 0xFF00U) >> 8);
// }
